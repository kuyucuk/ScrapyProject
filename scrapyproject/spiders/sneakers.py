    ...
    def parse(self, response):
        with open("sneakers.txt", "a", encoding="utf-8") as file:
            ...
            if str(response.xpath(
                    '//*[@id="productdetail"]/section[1]/section/section/div/div/article/div[1]/div[2]/div[1]/@*').extract()) != str(['product-description__table']):
            ...
            for eskifiyat in response.css("span.nobreak"):
                yazar11 = eskifiyat.xpath(
                    '//*[@id="productdetail"]/section[1]/div[1]/div/div/div[2]/div/div[4]/div[1]/div/div/span/span/span/node()').extract()[0]
