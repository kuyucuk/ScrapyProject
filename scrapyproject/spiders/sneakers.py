    ...
    def parse(self, response):
        with open("sneakers.txt", "a", encoding="utf-8") as file:
            for marka in response.css("span.product__brand"):
                doc = marka.xpath(
                    '//*[@id="productdetail"]/section[1]/div[1]/div/div/div[2]/div/div[1]/div[1]/h1/span[1]').extract()
            ...
            for model in response.css("span.product__brand"):
                doc = model.xpath(
                    '//*[@id="productdetail"]/section[1]/div[1]/div/div/div[2]/div/div[1]/div[1]/h1/span[2]').extract()
                sel = Selector(text=str(doc), type="html")
            ...
            for cins in response.css("span.product__brand"):
                doc = cins.xpath(
                    '//*[@id="productdetail"]/section[1]/div[1]/div/div/div[2]/div/div[1]/div[1]/h1/span[3]').extract()
                sel = Selector(text=str(doc), type="html")
            ...
            for renk in response.css("span.color-desc"):
                doc = renk.xpath(
                    '//*[@id="productdetail"]/section[1]/div[1]/div/div/div[2]/div/div[3]/div[1]/div/div/div/span').extract()
                sel = Selector(text=str(doc), type="html")
